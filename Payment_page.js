describe('Payment Page', () => {
    beforeEach(async function () {
        browser.url('https://nederlandscasinos.net/payments/ideal-casino/');
    ...
    it('Check displaying of breadcrumps', () => {
        const breadcrumps = $('body > div > div:nth-child(1) > div > div.bfad93f > div > p > span > span');
    ...
    it('Check casinos logo', async () => {
        ...
        expect(image).toHaveAttr('alt="iDEAL casino"')
    });
